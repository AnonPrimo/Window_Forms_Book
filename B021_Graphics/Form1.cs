...
namespace B021_Graphics
{
    public partial class Form1 : Form
    {
        ...
        private void drawDiagram(object sender, PaintEventArgs e)
        {
            ...
            x1 = 50;
            y1 = this.ClientSize.Width - 20 - (int)((this.ClientSize.Height - 100) *
                (d[0] - min) / (max - min));

            g.DrawRectangle(Pens.Black, x1 - 2, y1 - 2, 4, 4);

            g.DrawString(Convert.ToString(d[0]), dFont,
                    Brushes.Black, x1 - 10, y1 - 20);
            ...
            for (int i = 0; i < d.Length; ++i)
            {
                ...
                g.DrawString(Convert.ToString(d[i]), dFont, Brushes.Black,
                    x2 - 10, y2 - 20);
